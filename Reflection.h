...
public:
    ...
    virtual Vector3 Sample_f(const Vector3 &wo, Vector3 *wi, const Point2f &sample, double *pdf, MaterialType *sampledType = nullptr) const;
    virtual Vector3 rho(const Vector3 &wo, int nSamples, const Vector2 *samples) const;
    virtual Vector3 rho(int nSamples, const Point2f *samples1, const Point2f *samples2) const;
