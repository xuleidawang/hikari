...
int main(int argc, char** argv){	
  ...
  scene.add(dynamic_cast<Object*>(new Mesh(Vector3(50,16.5,55.5), "../obj/dragon2.obj", Material(DIFF, Vector3(0.9, 0.9, 0.9)))) );
...
//   renderer.save_image();              // Save image
  ...
  scene1.add( dynamic_cast<Object*>(new Sphere(1000,Vector3(0,0,-1000), Vector3(), Vector3(1.0,1.0,1.0)*.999,DIFF)));
